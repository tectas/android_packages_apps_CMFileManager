...
import com.cyanogenmod.filemanager.ThumbnailUtilConstants;
...
public class IconHolder {
    ...
    private class WorkerHandler extends Handler {
        ...
        private Drawable getImageDrawable(String file) {
            Bitmap thumb = ThumbnailUtilConstants.createImageThumbnail(
                    MediaHelper.normalizeMediaPath(file),
                    ThumbnailUtilConstants.TARGET_SIZE_MICRO_THUMBNAIL);
            if (thumb == null) {
                return null;
            }
        ...
        private Drawable getVideoDrawable(String file) {
            Bitmap thumb = ThumbnailUtilConstants.createVideoThumbnail(
                    MediaHelper.normalizeMediaPath(file),
                    ThumbnailUtilConstants.TARGET_SIZE_MICRO_THUMBNAIL);
            if (thumb == null) {
                return null;
        ...
        private Drawable getAlbumDrawable(long albumId) {
            ...
            Bitmap thumb = ThumbnailUtilConstants.createImageThumbnail(path,
            		ThumbnailUtilConstants.TARGET_SIZE_MICRO_THUMBNAIL);
            if (thumb == null) {
                return null;
            }
